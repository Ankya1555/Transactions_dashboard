const fakeApi = {
  ...
  export const fetchTransactions = (month, searchText, page) => {
    // Simulate a delay
    return new Promise((resolve) => {
      setTimeout(() => {
        resolve({
          transactions: fakeApi.transactions.filter(transaction => 
          ...
          totalPages: 1, // For simplicity, assume only one page
          statistics: fakeApi.statistics,
          chartData: fakeApi.chartData,
        });
      }, 500);
    });
  };
